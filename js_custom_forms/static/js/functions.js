(function() {
    ...
    $(document).ready(function(){
        ...
        /*
        var $precio = $('form.js_add_cart_variants div.js_product b.oe_price > span.oe_currency_value');
        var $contenido_precio = $precio.html();        
        console.log('Precio: ' + $contenido_precio);
        if ($contenido_precio === '0,00'){
            var $ul2 = $precio.closest('form.js_add_cart_variants');
            var $parent2 = $ul2.closest('div.js_product');
            var $price_wrap2 = $parent2.find("b.oe_price:first");
            $('<span class="no-price text-danger">Consultar Precio</span>').insertAfter($price_wrap2);
            $parent2.find("#add_to_cart").hide();
            $parent2.find("div.css_quantity").hide();
            $price_wrap2.hide();
            console.log('chapuza 3');
        }*/
