...
odoo.define('js_pagination_infinite_scroll', function (require) {
    ...
    var JsPagination = Class.extend({
        ...
        loadProductsActions: function () {
            ...
            ReloadScript('/website_sale_comparison/static/src/js/website_sale_comparison.js');
            ReloadScript('/clarico_compare/static/src/js/compare.js');
            ReloadScript('/clarico_similar_product/static/src/js/similar_product.js');
            ReloadScript('/clarico_rating/static/src/js/rating.js');
        ...
        loadNextpage: function($productstable, $productsContainer, $paginationElement, $nextPageLink){
            ...
            var loadingText = _t('Cargando más productos, espere o haga click aquí para cancelar...'); // Loading more products, wait a moment or click here to cancel...
