...
Adaptado a la versión 11. Para ello cambié en el archivo __manifest__ depends>report por depends>web,
y en layout.xml inherit_id="report.minimal_layout" por inherit_id="web.minimal_layout"
